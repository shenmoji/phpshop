<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\www.php15shop.com\public/../application/home\view\index\index.html";i:1529494356;s:58:"D:\www.php15shop.com\application\home\view\public\nav.html";i:1529675947;}*/ ?>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php foreach($crazyGoods as $goods):?>
						<li>
							<dl>
								<dt><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><img src="/upload/<?php echo json_decode($goods['goods_img'])[0]; ?>" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<?php foreach($bestGoods as $goods):?>
						<li>
							<dl>
								<dt><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><img src="/upload/<?php echo json_decode($goods['goods_img'])[0]; ?>" alt="" /></a></dt>
								<dd><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><?php echo $goods['goods_name']; ?></a></dd>
				...
				<div class="guess none">
					<ul>
						<?php foreach($guessGoods as $goods):?>
						<li>
							<dl>
								<dt><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><img src="/upload/<?php echo json_decode($goods['goods_img'])[0]; ?>" alt="" /></a></dt>
								<dd><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><?php echo $goods['goods_name']; ?></a></dd>
