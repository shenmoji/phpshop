<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www.php15shop.com\public/../application/home\view\cart\cartindex.html";i:1529664107;s:58:"D:\www.php15shop.com\application\home\view\public\nav.html";i:1529675947;}*/ ?>
...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td class="col4" goods_attr_ids = "<?php echo $data['goods_attr_ids']; ?>" goods_id = "<?php echo $data['goods_id']; ?>"> 
						<a href="javascript:;" class="reduce_num"></a>
						<input type="text" name="amount" value="<?php echo $data['goods_number']; ?>"  class="amount"/>
					...
					<td class="col6"><a href="javascript:void(0);" class="delcartgoods" goods_attr_ids = "<?php echo $data['goods_attr_ids']; ?>" goods_id = "<?php echo $data['goods_id']; ?>">删除</a></td>
				</tr>
				<?php endforeach;?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="javascript:void(0);" style="margin-left: 20px" class="continue" id="clearCart">清空购物车</a>
...
<script type="text/javascript">
	$(".delcartgoods").click(function(){
		...
		$.get("<?php echo url('home/cart/ajaxdelgoods'); ?>",param,function(json){
			if(json.code == 200){
	...
	$("#clearCart").click(function(){
		$.get("<?php echo url('home/cart/cartCartgoods'); ?>","",function(json){
			if(json.code == 200){
				layer.msg(json.message,{"icon":1,"time":1500});
				$("tbody").html('<p style="text-align:centen";>购物空空如也,去<a href="/">首页</a>看看</p>')
			}else{
				layer.msg(json.message,{"icon":0,"time":1500});
			}
		},'json')
