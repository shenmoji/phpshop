<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\www.php15shop.com\public/../application/home\view\goods\detail.html";i:1529666171;s:58:"D:\www.php15shop.com\application\home\view\public\nav.html";i:1529675947;}*/ ?>
...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			...
			<div class="cart fl">
				<dl>
					<dt>
						<a href="<?php echo url('home/cart/cartindex'); ?>">去购物车结算</a>
						<b></b>
					</dt>
					<dd>
						<div class="prompt">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl cat1">
				...
				<div class="cat_bd"> 
					<!-- 一级分类 -->
					<?php foreach(isset($children[0])?:array() as $one_cat_id):?>
					<div class="cat item1">
						<h3><a href=""><?php echo $cats[ $one_cat_id ]['cat_name']; ?></a> </h3>
						<div class="cat_detail">
							<!-- 二级分类 -->
							<?php foreach(isset($children[$one_cat_id])?$children[$one_cat_id]:array() as $two_cat_id):?>
							<dl class="dl_1st">
								<dt><a href="<?php echo url('home/category/index',['cat_id'=>$two_cat_id]); ?>"><?php echo $cats[ $two_cat_id ]['cat_name']; ?></a></dt>
								<dd>
									<!-- 三级分类 -->
									<?php foreach(isset($children[$two_cat_id])?$children[$two_cat_id]:array() as $three_cat_id) :?>
			...
			<div class="navitems fl">
				<ul class="fl">
					...
					<?php if(is_array($familyData) || $familyData instanceof \think\Collection || $familyData instanceof \think\Paginator): $i = 0; $__LIST__ = $familyData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>
					<li><a href="<?php echo url('home/category/index',['cat_id'=>$cat['cat_id']]); ?>"><?php echo $cat['cat_name']; ?></a></li>
	...
	<?php if(is_array($familyData) || $familyData instanceof \think\Collection || $familyData instanceof \think\Paginator): $i = 0; $__LIST__ = $familyData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>
			...
			<?php endforeach; endif; else: echo "" ;endif; ?><?php echo $goods_data['goods_name']; ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_left fl">
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<?php foreach($historyGoods as $goods):?>
					<dl class="last">
						<dt><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><img src="/upload/<?php echo json_decode($goods['goods_thumb'])[0]; ?>" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo $goods_data['goods_name']; ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="/upload/<?php echo $goods_data['goods_img'][0]; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/upload/<?php echo $goods_data['goods_middle'][0]; ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php foreach(isset($goods_data['goods_middle'])?$goods_data['goods_middle']:array() as $k=>$v): ?>
								<li <?php echo $k==0?'class="cur"':""; ?> >
									<a <?php echo $k==0?'class="zoomThumbActive"':""; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/upload/<?php echo $v; ?>',largeimage: '/upload/<?php echo $goods_data['goods_img'][$k]; ?>'}"><img src="/upload/<?php echo $goods_data['goods_thumb'][$k]; ?>"></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo $goods_data['goods_sn']; ?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo $goods_data['goods_price']*1.2; ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong id="goods_price_final">
								<!-- 先给价格设置一个id goods_price_final -->
						￥<?php echo $goods_data['goods_price']; ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo $goods_data['create_time']; ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<?php foreach($single_data as $attr_id => $attr):?>
							<li class="product">
								<dl>
									<dt><?php echo $attr[0]['attr_name']; ?>：</dt>
									<dd class="goods_attr_price">
										<!-- 在给下面设置单击事件 获取attr_price -->
										<?php foreach($attr as $k => $v): ?>
										<a <?php echo $k==0?'class="selected"':""; ?> href="javascript:;">
										<?php echo $v['attr_value']; ?> 
										<input type="hidden" value="<?php echo $v['attr_price']; ?>">
											<input type="radio" name="color" value="<?php echo $v['goods_attr_id']; ?>" <?php echo $k==0?'checked="checked"':""  ;?> />
										</a>
										<?php endforeach;?>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="button" goods_id="<?php echo $goods_data['goods_id']; ?>" value=""  class="add_btn" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div ">
						<div class="attr mt15">
							<ul>
								<?php foreach($onlyData as $attr):?>
								<li><span><?php echo $attr['attr_name']; ?></span><?php echo $attr['attr_value']; ?></li>
								<?php endforeach;?>
							</ul>
						</div>
						...
						<div class="desc mt10">
							...
							<?php echo $goods_data['goods_desc']; ?>
						</div>
					</div>
					<!-- 商品介绍 end -->
...
<script type="text/javascript">
	$(".add_btn").click(function(){
		...
		$.get("<?php echo url('home/Goods/ajaxaddcart'); ?>",param,function(json){
			if(json.code == 200){
					//询问框
					layer.confirm(json.message, {
					  btn: ['去购物车结算','逛逛'] //按钮
					   ...
					   //跳到登录页面
					   location.href= "<?php echo url('home/cart/cartindex'); ?>";
					}, function(){
					    //关闭遮盖
					...
					layer.confirm(json.message, {
					  btn: ['登录','在逛逛'] //按钮
					   ...
					   location.href= "<?php echo url('home/public/login',['return_url'=>$goods_data['goods_id']]); ?>";
					}, function(){
					    //关闭遮盖
					    layer.closeAll();
					})
	...
	// $(".goods_attr_price").click(function(){
	// 	var hidden_price  =  $(this).
	// });
</script>
</html>