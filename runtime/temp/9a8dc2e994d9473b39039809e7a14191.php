<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www.php15shop.com\public/../application/home\view\category\index.html";i:1529666182;s:58:"D:\www.php15shop.com\application\home\view\public\nav.html";i:1529493502;}*/ ?>
...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="navitems fl">
				<ul class="fl">
					<li class="current"><a href="<?php echo url('home/index/index'); ?>">首页</a></li>
						<?php if(is_array($navCats) || $navCats instanceof \think\Collection || $navCats instanceof \think\Paginator): $i = 0; $__LIST__ = $navCats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_left fl mt10">
			...
			<div class="catlist">
				<!-- 当前分类的顶级分类名称 -->
				<h2><?php echo $familyCats[0]['cat_name']; ?></h2>
				<div class="catlist_wrap">
					<!-- 循环顶级下面的2级分类 -->
					<?php  foreach($children[$familyCats[0]['cat_id']] as $two_cat_id):?>
					<div class="child">
						<h3 class="on"><b></b><?php echo $cats[ $two_cat_id ]['cat_name']; ?></h3>
						<ul>
							<!-- 循环2级下面的3级分类 -->
							<?php foreach($children[$two_cat_id] as $three_cat_id) :?>
							<li><a href="<?php echo url('home/category/index',['cat_id'=>$three_cat_id]); ?>">
							<?php echo $cats[$three_cat_id]['cat_name']; ?></a></li>
							<?php endforeach;?>
						</ul>
					</div>
					<?php endforeach; ?>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<?php foreach($catsGoods as $goods): ?>
					<li>
						<dl>
							<dt><a href="<?php echo url('home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><img src="/upload/<?php echo json_decode($goods['goods_middle'])[0]; ?>" alt="" /></a></dt>
