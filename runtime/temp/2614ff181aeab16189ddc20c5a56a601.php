<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\www.php15shop.com\public/../application/home\view\public\updpassword.html";i:1529291590;}*/ ?>
			...
			<div class="login_form fl">
				<form action="" method="post">
					...
					<ul>
						<li>
							<label for="">密码:</label>
							<input type="password" class="txt" name="password"  placeholder="请输入密码" />
						</li>
						<li>
							<label for="">请在确认密码:</label>
							<input type="password" class="txt" name="repassword"  placeholder="请确认密码" />
						</li
						
						<li>
							<label for="">&nbsp;</label>
							<input type="button" value="重置密码" id="updpassword" style="width: 100px" />
						</li>
					</ul>
				</form>
...
$("#updpassword").click(function(){
	...
	$.post("<?php echo url('home/public/updpassword'); ?>",param,function(json){
		if(json.code == 200){
			layer.confirm(json.message,{btn:['好了','算了']}
				,function(){
					location.href="<?php echo url('home/public/login'); ?>"
				},function(){
