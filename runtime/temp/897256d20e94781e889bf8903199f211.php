<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\www.php15shop.com\public/../application/home\view\public\findemail.html";i:1529240094;}*/ ?>
...
<script type="text/javascript">
	...
	$("#sendEmail").click(function(){
		...
		$.get("<?php echo url('home/public/findEmail'); ?>",{"email":email},function(json){
			if(json.code == 200){
				countDown();
