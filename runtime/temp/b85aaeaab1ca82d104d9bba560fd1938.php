<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\www.php15shop.com\public/../application/admin\view\category\index.html";i:1529148905;}*/ ?>
...
<body>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo str_repeat('&nbsp;&nbsp;',$list['deep']*2); ?><?php echo $list['cat_name']; ?></td>
                    <td><?php echo $lists[ $list['pid'] ] ['cat_name']; ?></td>
                    <td><?php echo !empty($list['is_show'])?"显示":"不显示"; ?></td>
    <td>
        <a href="<?php echo url('admin/category/upd',['cat_id'=>$list['cat_id']]); ?>" class="tablelink">编辑</a>
         <a href="javascript:;" cat_id=<?php echo $list['cat_id']; ?>   class="delCat tablelink"> 删除</a>
     </td>
                </tr>
    ...
    <script type="text/javascript">
       $(".delCat").click(function(){
           ...
           // alert(type_id);
           $.get("<?php echo url('admin/category/ajaxdel'); ?>",{"cat_id":cat_id},function(data){
               if(data.code == 200){
                   alert(data.message);
