<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\www.php15shop.com\public/../application/admin\view\role\index.html";i:1528796784;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo !empty($list['all_auth'])?$list['all_auth']:'所有权限'; ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$list['create_time']); ?></td>
    <td>
        <a href="<?php echo url('admin/role/upd',['role_id'=>$list['role_id']]); ?>" class="tablelink">编辑</a>
         <a href="<?php echo url('admin/role/del',['role_id'=>$list['role_id']]); ?>"  class="tablelink"> 删除</a>
     </td>
                </tr>
