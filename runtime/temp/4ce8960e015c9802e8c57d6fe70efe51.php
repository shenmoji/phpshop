<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\www.php15shop.com\public/../application/home\view\public\register.html";i:1529239931;}*/ ?>
			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						...
						<li>
							<label for="">邮箱：</label>
							<input type="text" class="txt" name="email" id="email" /><i id="icate"></i>
						...
						<li class="checkcode">
							...
							<span>看不清？<a href="javascript:;" id="Catcaptcha">换一张</a></span>
						</li>
						<li>
							<label for="">&nbsp;</label>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="submit" value="" class="login_btn" onclick="return submitform()" />
						</li>
					</ul>
				</form>
...
$("#sendSms").click(function(){
	...
	countDown();
	$.get("<?php echo url('home/public/sendSms'); ?>",{"phone":phone},function(json){
		console.log(json);
