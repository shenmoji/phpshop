<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\www.php15shop.com\public/../application/home\view\public\find.html";i:1529232377;}*/ ?>
			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">邮箱:</label>
							<input type="text" class="txt" name="email" placeholder="请输入注册时填写的邮箱" />
						</li>
						
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="captcha" />
							<img src="<?php echo captcha_src('3'); ?>" alt="" id="captcha" />
							<span>看不清？<a href="javascript:;" id="changeCaptcha">换一张</a></span>
						</li>
						
						<li>
							<label for="">&nbsp;</label>
							<input type="submit" value="找回密码" style="width: 100px" />
						</li>
					</ul>
				</form>
...
<script type="text/javascript">
	$("#changeCaptcha").click(function(){
		$("#captcha").attr('src',"<?php echo captcha_src('3'); ?>?_="+Math.random());
	});
</script>
</html>